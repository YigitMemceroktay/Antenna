"""
train_resunet_big_v9.py  —  BigResUNet v9 (SmoothResUNet1D + AntennaNN Huber loss)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train BigResUNet v9 — SmoothResUNet + AntennaNN Huber loss")
